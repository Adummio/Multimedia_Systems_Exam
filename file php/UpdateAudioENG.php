...
if(is_null($audioid))
{
	$result = $link->query("INSERT INTO AUDIO(INGLESE) VALUES('$_POST[modifica]')");
...
else
{
	...
	$inglese = mysqli_fetch_object($audio)->INGLESE;
	unlink("audio/" . $inglese);
	$link->query("UPDATE AUDIO SET INGLESE = '$_POST[modifica]' WHERE ID = $audioid");
}

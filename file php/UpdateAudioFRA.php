...
if(is_null($audioid))
{
	$result = $link->query("INSERT INTO AUDIO(FRANCESE) VALUES('$_POST[modifica]')");
...
else
{
	...
	$francese = mysqli_fetch_object($audio)->FRANCESE;
	unlink("audio/" . $francese);
	$link->query("UPDATE AUDIO SET FRANCESE = '$_POST[modifica]' WHERE ID = $audioid");
}
